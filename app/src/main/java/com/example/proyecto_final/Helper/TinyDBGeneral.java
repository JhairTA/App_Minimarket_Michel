...
public class TinyDBGeneral {

    private SharedPreferences preferences;
    private String DEFAULT_APP_IMAGEDATA_DIRECTORY;
    private String lastImagePath = "";

    public TinyDBGeneral(Context appContext) {
    ...
    public ArrayList<ProductoGeneral> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<ProductoGeneral> playerList =  new ArrayList<ProductoGeneral>();

        for(String jObjString : objStrings){
            ProductoGeneral player  = gson.fromJson(jObjString,  ProductoGeneral.class);
    ...
    public void putListObject(String key, ArrayList<ProductoGeneral> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(ProductoGeneral player: playerList){
