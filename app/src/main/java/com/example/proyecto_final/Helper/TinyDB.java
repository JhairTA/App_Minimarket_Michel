...
public class TinyDB {
    ...
    public ArrayList<ProductoYogurts> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<ProductoYogurts> playerList =  new ArrayList<ProductoYogurts>();

        for(String jObjString : objStrings){
            ProductoYogurts player  = gson.fromJson(jObjString,  ProductoYogurts.class);
    ...
    public void putListObject(String key, ArrayList<ProductoYogurts> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(ProductoYogurts player: playerList){
