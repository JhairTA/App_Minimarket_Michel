...
public class TinyDB2 {

    private SharedPreferences preferences;
    private String DEFAULT_APP_IMAGEDATA_DIRECTORY;
    private String lastImagePath = "";

    public TinyDB2(Context appContext) {
    ...
    public ArrayList<ProductoLeches> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<ProductoLeches> playerList =  new ArrayList<ProductoLeches>();

        for(String jObjString : objStrings){
            ProductoLeches player  = gson.fromJson(jObjString,  ProductoLeches.class);
    ...
    public void putListObject(String key, ArrayList<ProductoLeches> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(ProductoLeches player: playerList){
