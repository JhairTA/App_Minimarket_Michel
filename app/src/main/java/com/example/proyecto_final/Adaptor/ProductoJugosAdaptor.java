...
public class ProductoJugosAdaptor extends RecyclerView.Adapter<ProductoJugosAdaptor.ViewHolder> {
    ArrayList<ProductoGeneral> productoJugo;

    public ProductoJugosAdaptor(ArrayList<ProductoGeneral> categoryProduct1) {
        this.productoJugo = categoryProduct1;
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull ProductoJugosAdaptor.ViewHolder holder, int position) {
        holder.title.setText(productoJugo.get(position).getTitle());
        holder.fee.setText(String.valueOf(productoJugo.get(position).getFee()));
